...
public class Platform {
    ...
    public RemoteWebDriver getDriver() throws Exception
    {
        ...
        }else if  (this.isMW())
        {
            ...
            throw new Exception("Cannot detect type of the of the Driver. Platform value:"+this.getPlatformVar());
        }
    ...
    private DesiredCapabilities getIOSDesiredCapabilities()
    {
        ...
        capabilities.setCapability("app","/Users/apple/Desktop/JavaAppiumAutomation/apks/Wikipedia.app");
