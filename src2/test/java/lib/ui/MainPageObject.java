...
{
    protected RemoteWebDriver driver;//инициализация драйвера
    public MainPageObject (RemoteWebDriver driver)//конструктор к которому будут обращатся все тесты
    {
        this.driver = driver;
    }
    ...
    public WebElement waitForElementAndClick(String locator, String error_message, long timeoutInSeconds)
    {
        ...
        element.click();
        System.out.println("Test waitForElementAndClick" +locator);
        System.out.println("Test waitForElementAndClick E" +element);
        return element;
    }
    ...
    public int testSizeListForElementFind(String locator)
    {
        By by = this.getLocatorByString(locator);

        List testElement = driver.findElements(by) ;
