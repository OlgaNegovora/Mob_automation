...
public class SearchPageObject extends MainPageObject //методы для поиска
   {
       ...
       {
           this.waitForElementPresent(By.xpath(SEARCH_EMPTY_RESULT_ELEMENT),"Cannot find element result element.",15);
       }
       ...
       {
          return this.testSizeListForElementFind(By.id(SEARCH_RESULT));

       }

       public void waitForSearchListsToDisappear()
       {
           this.waitForElementNotPresent(By.id(SEARCH_RESULT),"Search lists is still present!",15);
       }
